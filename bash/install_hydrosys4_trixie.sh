...
function install_dependencies() {
    ...
    INSTALL_PIP="flask apscheduler pyserial pillow pbkdf2 tornado spidev future Flask-SQLAlchemy"
...
function uninstall() {
    ...
    REMOVE_PIP="flask apscheduler pyserial pillow pbkdf2 tornado RPi.GPIO rpi-lgpio spidev future Flask-SQLAlchemy"
...
ExecStartPre=/usr/sbin/hwclock --hctosys || true
