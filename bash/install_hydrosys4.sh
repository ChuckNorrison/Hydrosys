...
function install_dependencies() {
    ...
    INSTALL_APT="python3-dev python3-pip python3-future python3-smbus git build-essential python3-setuptools i2c-tools fswebcam libjpeg-dev libopenjp2-7 dnsutils dnsmasq hostapd cmake libjpeg9-dev nginx iptables"
...
function uninstall() {
    REMOVE_APT="python3-dev python3-pip python3-future python3-smbus git build-essential python3-setuptools i2c-tools fswebcam libjpeg-dev libopenjp2-7 dnsutils dnsmasq hostapd cmake libjpeg9-dev nginx"
